...
$contact = $conn->query("SELECT * FROM site_contact LIMIT 1")->fetch_assoc();
?>
...
<main>
  ...
  <div class="product-container">
        ...
        <div class="product-main">
          ...
          <div class="contact-card-container whatsapp">
            ...
            <div class="contact-details">
              ...
              <p>
                <a href="https://wa.me/<?php echo preg_replace('/[^0-9]/', '', $contact['whatsapp']); ?>" target="_blank"><?php echo preg_replace('/[^0-9]/', '', $contact['whatsapp']); ?></a>
              </p>
            </div>
          </div>
          <!--  -->
          ...
          <div class="contact-card-container location">
            ...
            <div class="contact-details">
              ...
              <p>
                <?php echo htmlspecialchars($contact['localisation']); ?>
              </p>
            </div>
          </div>
          <!--  -->
	...
	<iframe
	  ...
	  src="https://www.google.com/maps?q=<?php echo urlencode($contact['localisation']); ?>&output=embed">
	</iframe>
    <br />
	<small>
